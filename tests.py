...
class TestDownloader(unittest.TestCase):
    def test_URL_parsing(self):
        ...
        with patch("__builtin__.open", mock_open(read_data = content1)) as mock_file:
            ...
            self.assertEqual(instance.urls, ["http://host.com/file.png", "http://host.com/file2.png"])
        ...
        with patch("__builtin__.open", mock_open(read_data = content2)) as mock_file:
            ...
            self.assertEqual(instance.urls, 
                ["http://host.com/file.png", "http://host.com/file2.png", "http://host.com/file3.png"])
    ...
    def test_URL_calling(self, mocked_urlopen):
